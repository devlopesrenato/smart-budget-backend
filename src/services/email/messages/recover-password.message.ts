export function recoverPasswordMessage(name: string, email: string, token: string): string {
    return `
      <div
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="padding:24px 24px 0 24px">
                      ...
                      <p>
                        <a style="text-decoration:none;color:#1c1d1f">Agradecemos por utilizar nosso aplicativo!</a>
                      </p>
                      <p>
                        <a style="text-decoration:none;color:#1c1d1f">Para redefinir sua senha, por favor clique no botão
                          abaixo:</a>
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:16px 24px 0 24px">
                      <p style="margin-bottom:0">
                        <a style="text-decoration:none;color:#1c1d1f;font-size:16px">Lembramos que o link de recuperação é válido por 5
                          minutos. Caso não redefina sua senha dentro desse período, será necessário realizar a solicitação novamente.</a>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:24px 24px 0 24px">
                      ...
                      <p style="margin-bottom:0;font-size:14px">
                        Se você não realizou a recuperação da sua senha, pedimos que desconsidere este email.
                      </p>
